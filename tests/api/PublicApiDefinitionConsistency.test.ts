...
describe('public API declaration file', () => {
    ...
    it('matches critical public type and event payload shapes', () => {
        ...
        const interfacePropertyChecks = [
            ...
            { interfaceName: 'NavigatorRowContextMenuContext', propertyName: 'providerId' },
            { interfaceName: 'NavigatorRowContextMenuContext', propertyName: 'rowId' },
            { interfaceName: 'NavigatorRowContextMenuContext', propertyName: 'kind' },
