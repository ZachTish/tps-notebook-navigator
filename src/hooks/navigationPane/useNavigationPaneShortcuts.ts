...
export function useNavigationPaneShortcuts({
    ...
    return useMemo(
        () => ({
            ...
            handleShortcutTagNoteClick: shortcutActions.handleShortcutTagNoteClick,
            handleShortcutTagNoteMouseDown: shortcutActions.handleShortcutTagNoteMouseDown,
            handleShortcutPropertyNoteClick: shortcutActions.handleShortcutPropertyNoteClick,
            handleShortcutPropertyNoteMouseDown: shortcutActions.handleShortcutPropertyNoteMouseDown,
        ...
        [
            ...
            shortcutActions.handleShortcutPropertyNoteMouseDown,
            ...
            shortcutActions.handleShortcutTagNoteClick,
            shortcutActions.handleShortcutTagNoteMouseDown,
