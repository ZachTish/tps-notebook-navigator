...
import { PROPERTIES_ROOT_VIRTUAL_FOLDER_ID, SHORTCUTS_VIRTUAL_FOLDER_ID, VirtualFolder, type CSSPropertiesWithVars } from '../types';
...
export const VirtualFolderComponent = React.memo(function VirtualFolderComponent({
    ...
    const shouldDisplayCount = useMemo(() => {
        ...
        if (virtualFolder.id === PROPERTIES_ROOT_VIRTUAL_FOLDER_ID && !includeDescendantNotes) {
            return false;
        }
