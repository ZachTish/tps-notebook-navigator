...
import {
    ...
    type LinePropertyInheritance,
    type ListNoteGroupingOption,
    type ListPaneAppearance,
    type MultiValueGrouping,
    type NoValueGroupPosition,
    type NotebookNavigatorSettings,
    type TextCountDisplay
} from './types';

export type { LinePropertyInheritance, ListPaneAppearance, MultiValueGrouping, NoValueGroupPosition, TpsTypeAppearance } from './types';
...
export function getStoredListPaneAppearanceFields(appearance: ListPaneAppearance | undefined): ListPaneAppearanceFields | null {
    ...
    if (isMultiValueGrouping(appearance.multiValueGrouping)) {
        normalized.multiValueGrouping = appearance.multiValueGrouping;
    }
    if (isNoValueGroupPosition(appearance.noValueGroupPosition)) {
        normalized.noValueGroupPosition = appearance.noValueGroupPosition;
    }
...
export function resolveListPaneAppearance({
    ...
    return {
        ...
        multiValueGrouping: resolveMultiValueGrouping(appearance?.multiValueGrouping),
        noValueGroupPosition: resolveNoValueGroupPosition(appearance?.noValueGroupPosition)
    };
}
